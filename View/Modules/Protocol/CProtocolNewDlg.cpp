...
CProtocolNewDlg::CProtocolNewDlg(const QString &name, const QStringList &names, QWidget *parent, Qt::WindowFlags f) :
...
QString CProtocolNewDlg::getName() const
{
    return m_name;
}

QString CProtocolNewDlg::getKeywords() const
{
    return m_keywords;
}

QString CProtocolNewDlg::getDescription() const
{
    return m_description;
}

void CProtocolNewDlg::initLayout()
{
...
void CProtocolNewDlg::initConnections()
{
    connect(m_pBtnOk, &QPushButton::clicked, this, &CProtocolNewDlg::validate);
    connect(m_pBtnCancel, &QPushButton::clicked, this, &CProtocolNewDlg::reject);
}

void CProtocolNewDlg::validate()
{
