...
void CPythonNewPluginDlg::initLayout()
{
    ...
    m_pComboPyProcessType->addItem(tr("Generic process"), PluginManager::CPROTOCOL_TASK);
    ...
    m_pComboPyWidgetType->addItem(tr("Empty widget"), PluginManager::CPROTOCOL_TASK_WIDGET);
