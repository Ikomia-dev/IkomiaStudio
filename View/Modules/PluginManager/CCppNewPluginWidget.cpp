...
void CCppNewPluginWidget::initLayout()
{
    ...
    m_pComboCppProcessType->addItem(tr("Generic process"), PluginManager::CPROTOCOL_TASK);
    ...
    m_pComboCppWidgetType->addItem(tr("Empty widget"), PluginManager::CPROTOCOL_TASK_WIDGET);
