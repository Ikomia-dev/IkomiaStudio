...
CGraphicsEllipsePropWidget::CGraphicsEllipsePropWidget(QWidget *parent) : QWidget(parent)
{
    initLayout();
    initConnections();
}
...
void CGraphicsEllipsePropWidget::propertyChanged()
{
    updateUI();
}

void CGraphicsEllipsePropWidget::initLayout()
{
...
void CGraphicsEllipsePropWidget::initConnections()
{
...
void CGraphicsEllipsePropWidget::updateUI()
{
    if(m_pProperty)
    {
